package buxompack.cards;

import basemod.BaseMod;
import basemod.abstracts.DynamicVariable;
import spireTogether.cards.CustomMultiplayerCard;
import buxompack.BuxomPack;
import buxompack.util.TriFunction;
...
import static buxompack.util.GeneralUtils.removePrefix;
import static buxompack.util.TextureLoader.getCardTextureString;
    ...
    @Override public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    BuxomPack.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
