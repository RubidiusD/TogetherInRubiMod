package hegemonpack.characters;
...
import hegemonpack.cards.arbiter.attacks.starter.Condemn;
import hegemonpack.cards.arbiter.attacks.starter.Strike;
import hegemonpack.cards.arbiter.skills.starter.Condone;
import hegemonpack.cards.arbiter.skills.starter.Defend;
import hegemonpack.relics.arbiter.StarterRelic;

import java.util.ArrayList;

import static hegemonpack.HegemonPack.characterPath;

public class Arbiter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = ("HegemonPack:" + "Arbiter"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass ARBITER;
        @SpireEnum(name = "Arbiter") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "Arbiter") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Arbiter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
