...
public class Reward extends BaseCard {
    public static final String ID = ("HegemonPack:" + Reward.class.getSimpleName());
    ...
    @Override public AbstractCard makeCopy() { return new Reward(); }
}
