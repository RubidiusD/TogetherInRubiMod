...
import static divapack.util.GeneralUtils.removePrefix;
import static divapack.util.TextureLoader.getCardTextureString;
    ...
    @Override public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    DivaPack.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
