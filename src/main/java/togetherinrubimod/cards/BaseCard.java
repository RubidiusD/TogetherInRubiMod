package togetherinrubimod.cards;

import basemod.BaseMod;
import basemod.abstracts.DynamicVariable;
import spireTogether.cards.CustomMultiplayerCard;
import togetherinrubimod.TogetherinRubiMod;
import togetherinrubimod.util.CardStats;
import togetherinrubimod.util.TriFunction;
...
import static togetherinrubimod.util.GeneralUtils.removePrefix;
import static togetherinrubimod.util.TextureLoader.getCardTextureString;
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    TogetherinRubiMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
